...
public class Favourites extends AppCompatActivity {
            ...
            public void FavouritesLoaded(List<Book> books, final List<String> favouritesKeys) {
                new FirebaseDatabaseHelper().readBooks(new FirebaseDatabaseHelper.DataStatus() {
                    ...
                    public void DataIsLoaded(List<Book> books, List<String> keys) {
                        ...
                        new RecyclerView_Config().setFavouritesConfig(mRecyclerView, Favourites.this,
                                books, keys, mFavourites, favouritesKeys);
                    }
                });
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mFavourites.setTitle("All Books");
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ((RecyclerView_Config.FavouritesAdapter) mRecyclerView.getAdapter()).getFilter().filter(newText);
                return false;
            }
        });
